	...
	<form id="qheb_grouplistform" name="qheb_grouplistform" action="<?=admin_url('admin.php?page=qhebunel/admin/optgroups.php');?>" method="post">
		...
		<div class="tablenav bottom">
			<div class="alignright actions">
				<input class="action-secondary button" type="submit" name="qheb_group_del" value="<?php _e('Delete'); ?>"/>
			</div>
			<br class="clear" />
		</div>
	</form>
				...
				<div class="stuffbox">
					...
					<div class="inside">
						<table class="editform">
							<tr>
								<th scope="row"><label for="qheb_group_name"><?php _e('Group name'); ?></label></th>
								<td><input type="text" name="qheb_group_name" id="qheb_group_name" value="<?=$qheb_edit_group['name'];?>" /></td>
							</tr>
							<tr>
								<th scope="row"><label for="qheb_group_prom"><?php _e('Prominent'); ?></label></th>
						...
						<div id="submitlink" class="submitbox">
							<div id="major-publishing-actions">
								<div id="publishing-action">
									<input type="submit" id="publish" class="button-primary" value="<?php _e('Save'); ?>" name="qheb_group_edit" />
								</div>
								<div class="clear"></div>
							</div>
							<div class="clear"></div>
			...
			<div class="stuffbox">
				...
				<div class="inside">
					...
					<div id="submitlink" class="submitbox">
						<div id="major-publishing-actions">
							<div id="publishing-action">
								<input type="submit" id="publish" class="button-primary" value="<?php _e('Create'); ?>" name="qheb_group_new" />
							</div>
							<div class="clear"></div>
						</div>
						<div class="clear"></div>
